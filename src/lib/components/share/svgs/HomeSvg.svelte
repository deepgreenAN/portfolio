...
<svg class:is_dark_mode={is_dark_mode} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
...
<style>
	svg {
		@apply h-10 w-10 text-gray-900 hover:text-gray-500 fill-current mx-auto;
	}
	.is_dark_mode {
		@apply text-gray-100 hover:text-gray-500;
	}
</style>