...
export class CanvasApp {
    ...
    */
    constructor(iapp_option) {
        var ret = wasm.canvasapp_new(addHeapObject(iapp_option));
    ...
    */
    static default_option() {
        var ret = wasm.canvasapp_default_option();
        return CanvasApp.__wrap(ret);
    }
    /**
    * ボールの初期化
    ...
    * @param {number} value
    */
    set_saturation_and_value(saturation, value) {
    ...
    */
    set_background_color(background_color) {
        var ptr0 = passStringToWasm0(background_color, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    ...
    */
    set_hue_range(color_max, color_min) {
    ...
    */
    set_is_color_vibration(is_color_vibration) {
        wasm.canvasapp_set_is_color_vibration(this.ptr, is_color_vibration);
    }
}
